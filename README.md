...
1. **Structured Tags:** Highest confidence capture (e.g., standard platform tags).
2. **Regex Scanning:** Fast parsing using word-boundary logic.
3. **Fuzzy Fallback (RapidFuzz):** Capturing typos, unique casing, and edge variances.
